...
from google.cloud.api_keys_v2.services.api_keys import ApiKeysAsyncClient
...
from google.cloud.api_keys_v2.services.api_keys import transports
...
@pytest.mark.parametrize("client_class", [
    ApiKeysClient, ApiKeysAsyncClient
])
@mock.patch.object(ApiKeysClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApiKeysClient))
@mock.patch.object(ApiKeysAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApiKeysAsyncClient))
...
def test_list_keys_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, resources.Key)
                   for i in results)
...
def test_get_key_string(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_key_string),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_undelete_key(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.undelete_key),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_lookup_key(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.lookup_key),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_lookup_key_async(transport: str = 'grpc_asyncio', request_type=apikeys.LookupKeyRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(apikeys.LookupKeyResponse(
            parent='parent_value',
            name='name_value',
        ))
...
def test_create_key_rest(request_type):
    ...
    request_init["key"] = {'name': 'name_value', 'uid': 'uid_value', 'display_name': 'display_name_value', 'key_string': 'key_string_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'annotations': {}, 'restrictions': {'browser_key_restrictions': {'allowed_referrers': ['allowed_referrers_value1', 'allowed_referrers_value2']}, 'server_key_restrictions': {'allowed_ips': ['allowed_ips_value1', 'allowed_ips_value2']}, 'android_key_restrictions': {'allowed_applications': [{'sha1_fingerprint': 'sha1_fingerprint_value', 'package_name': 'package_name_value'}]}, 'ios_key_restrictions': {'allowed_bundle_ids': ['allowed_bundle_ids_value1', 'allowed_bundle_ids_value2']}, 'api_targets': [{'service': 'service_value', 'methods': ['methods_value1', 'methods_value2']}]}, 'etag': 'etag_value'}
...
def test_create_key_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("keyId", )) & set(("parent", "key", )))
...
def test_create_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.create_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_key_rest_bad_request(transport: str = 'rest', request_type=apikeys.CreateKeyRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apikeys.ListKeysResponse.to_json(apikeys.ListKeysResponse())
        ...
        client.list_keys(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_keys_rest_bad_request(transport: str = 'rest', request_type=apikeys.ListKeysRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.get_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_key_rest_bad_request(transport: str = 'rest', request_type=apikeys.GetKeyRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_key_string_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ApiKeysRestInterceptor, "post_get_key_string") as post, \
         mock.patch.object(transports.ApiKeysRestInterceptor, "pre_get_key_string") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apikeys.GetKeyStringResponse.to_json(apikeys.GetKeyStringResponse())
        ...
        client.get_key_string(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_key_string_rest_bad_request(transport: str = 'rest', request_type=apikeys.GetKeyStringRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_key_rest(request_type):
    ...
    request_init["key"] = {'name': 'projects/sample1/locations/sample2/keys/sample3', 'uid': 'uid_value', 'display_name': 'display_name_value', 'key_string': 'key_string_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'annotations': {}, 'restrictions': {'browser_key_restrictions': {'allowed_referrers': ['allowed_referrers_value1', 'allowed_referrers_value2']}, 'server_key_restrictions': {'allowed_ips': ['allowed_ips_value1', 'allowed_ips_value2']}, 'android_key_restrictions': {'allowed_applications': [{'sha1_fingerprint': 'sha1_fingerprint_value', 'package_name': 'package_name_value'}]}, 'ios_key_restrictions': {'allowed_bundle_ids': ['allowed_bundle_ids_value1', 'allowed_bundle_ids_value2']}, 'api_targets': [{'service': 'service_value', 'methods': ['methods_value1', 'methods_value2']}]}, 'etag': 'etag_value'}
    request = request_type(**request_init)
...
def test_update_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.update_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_key_rest_bad_request(transport: str = 'rest', request_type=apikeys.UpdateKeyRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.delete_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_key_rest_bad_request(transport: str = 'rest', request_type=apikeys.DeleteKeyRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_undelete_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ApiKeysRestInterceptor, "post_undelete_key") as post, \
        ...
        client.undelete_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_undelete_key_rest_bad_request(transport: str = 'rest', request_type=apikeys.UndeleteKeyRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_lookup_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = apikeys.LookupKeyResponse.to_json(apikeys.LookupKeyResponse())
        ...
        client.lookup_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_lookup_key_rest_bad_request(transport: str = 'rest', request_type=apikeys.LookupKeyRequest):
    client = ApiKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_api_keys_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.api_keys_v2.services.api_keys.transports.ApiKeysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_api_keys_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.api_keys_v2.services.api_keys.transports.ApiKeysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ApiKeysTransport()
        adc.assert_called_once()
...
def test_api_keys_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.ApiKeysGrpcTransport, transports.ApiKeysGrpcAsyncIOTransport])
def test_api_keys_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.ApiKeysGrpcTransport, transports.ApiKeysGrpcAsyncIOTransport])
def test_api_keys_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_key_path():
    ...
    location = "clam"
    key = "whelk"
    expected = "projects/{project}/locations/{location}/keys/{key}".format(project=project, location=location, key=key, )
