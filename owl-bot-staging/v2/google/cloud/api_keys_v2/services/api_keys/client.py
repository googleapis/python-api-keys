...
class ApiKeysClient(metaclass=ApiKeysClientMeta):
    ...
    @staticmethod
    def key_path(project: str,location: str,key: str,) -> str:
        """Returns a fully-qualified key string."""
        return "projects/{project}/locations/{location}/keys/{key}".format(project=project, location=location, key=key, )
