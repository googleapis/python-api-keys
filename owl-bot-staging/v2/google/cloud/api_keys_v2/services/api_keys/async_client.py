...
from .transports.base import ApiKeysTransport, DEFAULT_CLIENT_INFO
...
class ApiKeysAsyncClient:
    ...
    get_transport_class = functools.partial(type(ApiKeysClient).get_transport_class, type(ApiKeysClient))
